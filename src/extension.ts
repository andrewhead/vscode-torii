...
export function activate(context: vscode.ExtensionContext) {
	...
	console.log('Congratulations, your extension "santoku" is now active!');
	...
	let disposable = vscode.commands.registerCommand('extension.helloWorld', () => {
		...
		const panel = SantokuPanel.createOrShow(context.extensionPath);

		// Display a message box to the user
		vscode.window.showInformationMessage('Hello, Santoku! Let\'s make some tutorials!');
	});
